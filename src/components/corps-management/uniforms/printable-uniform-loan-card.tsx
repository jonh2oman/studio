...
export const PrintableUniformLoanCard = forwardRef<HTMLDivElement, PrintableUniformLoanCardProps>(
  ({ issuedItem, uniformItem, cadet, corpsName, corpsLogo }, ref) => {
    return (
        ...
        <main className="flex-grow space-y-4 text-sm">
            <div className="grid grid-cols-2 gap-4 border p-3">
                ...
                <div>
                    ...
                    <p>{format(new Date(issuedItem.issueDate.replace(/-/g, '/')), 'dd MMMM yyyy')}</p>
                </div>
                 <div>
                    <h3 className="font-bold text-xs uppercase text-gray-500">Item Loaned</h3>
                    <p>{uniformItem.name}</p>
                </div>
                 <div>
                    <h3 className="font-bold text-xs uppercase text-gray-500">Size</h3>
                    <p>{uniformItem.size}</p>
                </div>
                 <div>
                    <h3 className="font-bold text-xs uppercase text-gray-500">Item Notes</h3>
                    <p>{uniformItem.notes || 'N/A'}</p>
                </div>
                <div>
                    <h3 className="font-bold text-xs uppercase text-gray-500">Return Date</h3>
                    <p>End of Training Year</p>
                </div>
            </div>
