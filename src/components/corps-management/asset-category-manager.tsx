...
export function AssetCategoryManager() {
    ...
    const handleAddCategory = () => {
        ...
        if (newCategory.trim() && !categories.includes(newCategory.trim())) {
            saveSettings({ assetCategories: [...categories, newCategory.trim()] });
            setNewCategory("");
    ...
    const handleRemoveCategory = (category: string) => {
        const categories = settings.assetCategories || [];
        saveSettings({ assetCategories: categories.filter(c => c !== category) });
    ...
    return (
        <Card>
            <CardHeader>
                <CardTitle>Manage Asset Categories</CardTitle>
                <CardDescription>Add or remove categories for assets.</CardDescription>
            </CardHeader>
